...
```{r}
grafica <- ggplot(monthly, aes(x=date, y=proportion_deaths, color="Clinic 1"))+geom_line(colour="#2E86C1")
grafica
```

#### 5.2 Estética de Etiquetas con la función labs
```{r}
grafica + labs(title="Clinic 1 - Proporción de Muertes por Número de Nacimientos", subtitle = "Desde 1841 Hasta 1849",
            x="Fecha (Años)", y="Proporción de Muertes por Número de Nacimientos")
```
